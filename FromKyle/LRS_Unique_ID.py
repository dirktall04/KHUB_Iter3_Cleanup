...
@author: kyleg
'''
from arcpy import da, env, MakeFeatureLayer_management, RemoveJoin_management, Dissolve_management, Delete_management, AddField_management, CalculateField_management, Sort_management, AddJoin_management
#target = r"Database Connections\SDEPROD_SHARED.sde\SHARED.NON_STATE_SYSTEM"
target = 'Database Connections\Conflation2012_sde.sde\Conflation.SDE.NG911\Conflation.SDE.RoadCenterlines'
...
def UniqueIDgen():
    for i in range(87, 88):
        ...
        # Could use the incrementer to assign a RouteNum, -- compare previous concat road name to the next concatroadname -- alphabetically
        # -- Would remove several of the steps that follow.
        # Then, run the sort on RouteNum1 and run an incrementer for the UniqueNum.
