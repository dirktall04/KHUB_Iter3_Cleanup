...
simplifiedPointsSource = r'C:\GIS\Geodatabases\KHUB\Testing\R6_For_Vertex_Simplification_03Ft.gdb\RoadCenterlines_03Ft_Points'
originalPointsAsLayer = 'OrgPoints'
simplifiedPointsAsLayer = 'SimPoints'

selectionTypeToUse = "NEW_SELECTION"

outputFile = 'stewardPointCountsR6_3FT.txt'
