...
simplifiedPointsSource = r'C:\GIS\Geodatabases\KHUB\Testing\R6_For_Vertex_Simplification_01Ft.gdb\RoadCenterlines_01Ft_Points'
originalPointsAsLayer = 'OrgPoints'
simplifiedPointsAsLayer = 'SimPoints'

selectionTypeToUse = "NEW_SELECTION"

outputFile = 'stewardPointCountsR6_1FT.txt'
