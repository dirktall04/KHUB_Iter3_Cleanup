...
from datareviewerchecks_config import (reviewerSessionGDBFolder,
    ...
    mainFolder, nullable,
    countyTarget_routesSourceCenterlines, countyTarget_OutputRoutes, countyTarget_startCalibrationPoints,
    countyTarget_endCalibrationPoints, countyTarget_mergedCalibrationPoints,
    countyTarget_dissolvedCalibrationPoints)

# createRoutesInputFC Variables: routesSourceCenterlines,
# createRoutesOutputFC Variable: outputRoutes
createRoutesInputFC = countyTarget_routesSourceCenterlines
createRoutesOutputFC = countyTarget_OutputRoutes
