...
simplifiedPointsSource = r'C:\GIS\Geodatabases\KHUB\Testing\R6_For_Vertex_Simplification_04Ft.gdb\RoadCenterlines_04Ft_Points'
originalPointsAsLayer = 'OrgPoints'
simplifiedPointsAsLayer = 'SimPoints'

selectionTypeToUse = "NEW_SELECTION"

outputFile = 'stewardPointCountsR6_4FT.txt'
